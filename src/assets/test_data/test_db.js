...
export const INQUIRIES = [
  ...
  },
  {
    ...
    is_branching: false,
    order: 1,
    context: "Branch 1 (Incorrect branch)",
    prompt: "First Inquiry",
  ...
  },
  {
    ...
    is_branching: false,
    order: 1,
    context: "Branch 2 (Correct branch)",
    prompt: "First Inquiry",
...
export const CHOICES = [
  ...
  // inquiry 6
  { id: 11, inquiry: 6, label: `Counting rotations for varying blade angles, constant factors.`, isCorrect: false, branchId: null },
  { id: 12, inquiry: 6, label: `Observing rotations for varying windspeeds, same blade area.`, isCorrect: false, branchId: null },
  { id: 13, inquiry: 6, label: `Counting rotations for varying windspeeds, different blade areas.`, isCorrect: false, branchId: null },
  { id: 14, inquiry: 6, label: `Counting rotations for varying blade areas, constant factors.`, isCorrect: true, branchId: null },
  // inquiry 7
